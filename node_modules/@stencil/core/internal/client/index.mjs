...
const patchEsm = () => {
    ...
    if (!(win.CSS && win.CSS.supports && win.CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import('./css-shim.stencil-client.mjs');
    }
...
const patchBrowser = async () => {
    ...
    if (importMeta !== '') {
        ...
        if (!window.customElements) {
            // @ts-ignore
            await import('./dom.stencil-client.mjs');
        }
...
export { Build, Context, H, H as HTMLElement, Host, attachShadow, bootstrapLazy, connectedCallback, consoleError, createEvent, cssVarShim, defineCustomElement, disconnectedCallback, doc, getAssetPath, getConnect, getContext, getElement, getHostRef, getMode, getValue, h, insertVdomAnnotations, isMemberInElement, loadModule, moduleCache, nextTick, parsePropertyValue, patchBrowser, patchDynamicImport, patchEsm, plt, postUpdateComponent, proxyComponent, proxyCustomElement, proxyNative, readTask, registerHost, registerInstance, renderVdom, setMode, setValue, styles, supportsConstructibleStylesheets, supportsListenerOptions, supportsShadowDom, win, writeTask };
